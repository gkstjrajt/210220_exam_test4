SELECT ID, NAME, CREDIT, LECTURER, WEEK, START_HOUR, END_END FROM COURSE_TBL;
...
DELETE FROM LECTURER_TBL WHERE IDX = 8;

INSERT INTO LECTURER_TBL VALUES (8, '윤교수', '잘생김', '개잘생김');

SELECT c.NAME AS NAME, CREDIT, l.NAME AS LECTURER FROM COURSE_TBL c JOIN LECTURER_TBL l ON c.LECTURER = l.IDX WHERE LECTURER = ?;

SELECT MAX(IDX)+1 FROM LECTURER_TBL;

SELECT COUNT(NAME) FROM LECTURER_TBL WHERE NAME = '윤교수';